...
class _AddPostState extends State<AddPost> {
  ...
  void addPost(String url) {
    ref.child(lunchCode).set({
      ...
      'service': facilitiesController.text.toString(),
      ...
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => const CompanyHome()));
              ...
              Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Gap(10),
                      const Text('Facilities & Services',style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 20)),
                      TextFormField(
                      ...
                      Column(
                        children: [
                          const Text('Destination Image',style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 20)),
                          const Gap(10),
                          InkWell(
