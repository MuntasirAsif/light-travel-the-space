...
class Styles{
  ...
  static TextStyle textStyle = TextStyle(fontSize: 12, color: textColor, fontWeight: FontWeight.w500);
  static TextStyle textStyle2 = TextStyle(fontSize: 14, color: textColor, fontWeight: FontWeight.w500);
  static TextStyle textStyle3 = TextStyle(fontSize: 17, color: textColor, fontWeight: FontWeight.w500);
  ...
  static TextStyle headLineStyle5 = const TextStyle(fontSize: 16, color: Colors.black, fontWeight: FontWeight.bold);
